<template>
    <div>
        ...
        <el-table style="width: 100%; margin-top: 10px;" :data="orderOverList.slice((currentPage-1)*pagesize,currentPage*pagesize)" > <!-- 从0开始，每页显示的数据 参考：http://www.manongjc.com/article/22017.html -->
            ...
            <el-table-column label="支付状态" prop="o_result" width="100" align="center"></el-table-column>
            ...
            <el-table-column label="操作" prop="doit" width="200" align="center">
                <template slot-scope="scope">
...
import { MessageBox } from 'element-ui'
    ...
    export default {
        ...
        methods: {
            ...
            handleUserList(){
                this.$api.order.getallorderOver().then(res =>{
                    if(res.code==1){

<template>
    <div>
        ...
        <el-table style="width: 100%; margin-top: 10px;" :data="orderLoseList.slice((currentPage-1)*pagesize,currentPage*pagesize)" > <!-- 从0开始，每页显示的数据 参考：http://www.manongjc.com/article/22017.html -->
            ...
            <el-table-column label="预订人" prop="o_name" width="105" align="center"></el-table-column>

            <el-table-column label="车牌号" prop="o_card" width="115" align="center"></el-table-column>

            <el-table-column label="联系方式" prop="o_phone" width="135" align="center"></el-table-column>

            <el-table-column label="下单时间" prop="o_time" width="180" align="center"></el-table-column>

            <el-table-column label="预订车位" prop="c_name" width="105" align="center">
            ...
            <el-table-column label="车位所属物业" prop="property.user.u_name" width="115" align="center">
                <template slot-scope="scope">
                    <el-popover trigger="click" placement="top-start" >
            ...
            <el-table-column label="操作" prop="doit" width="190" align="center">
                <template slot-scope="scope">
...
import { MessageBox } from 'element-ui'
    ...
    export default {
        ...
        methods: {
            ...
            handleUserList(){
                this.$api.order.getallorderLoseadmin().then(res =>{
                    if(res.code==1){

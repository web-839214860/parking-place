<template>
    <div>
        ...
        <el-table style="width: 100%; margin-top: 10px;" :data="orderSuccessList.slice((currentPage-1)*pagesize,currentPage*pagesize)" > <!-- 从0开始，每页显示的数据 参考：http://www.manongjc.com/article/22017.html -->
            ...
            <el-table-column label="预订人" prop="o_name" width="100" align="center"> 
            ...
            <el-table-column label="操作" prop="doit" width="165" align="center">
                <template slot-scope="scope">
...
import { MessageBox } from 'element-ui'
    ...
    export default {
        ...
        methods: {
            ...
            handleUserList(){
                this.$api.order.getallorderSuccessadmin().then(res =>{
                    if(res.code==1){
